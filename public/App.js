...
const css = {
	code: "img.svelte-1an2mgi{width:100%}div.svelte-1an2mgi{background:url(\"/images/indonesia.svg\") no-repeat;background-size:100%;height:55em}li.svelte-1an2mgi{width:25%;display:flex;flex-direction:column;height:20em;background-color:red}ul.svelte-1an2mgi{display:flex}h2.svelte-1an2mgi{font-size:1rem}a.svelte-1an2mgi{text-decoration:none;color:black}",
	map: "{\"version\":3,\"file\":\"Home.svelte\",\"sources\":[\"Home.svelte\"],\"sourcesContent\":[\"<script>\\r\\n\\texport let data;\\r\\n\\tconsole.log(\\\"home\\\");\\r\\n\\r\\n</script>\\r\\n<style>\\r\\n\\timg {\\r\\n\\t\\twidth: 100%;\\r\\n\\t}\\r\\n\\tdiv {\\r\\n\\t\\tbackground: url(\\\"/images/indonesia.svg\\\") no-repeat;\\r\\n\\t\\tbackground-size: 100%;\\r\\n\\t\\theight: 55em;\\r\\n\\t}\\r\\n\\tli {\\r\\n\\t\\twidth: 25%;\\r\\n\\t\\tdisplay: flex;\\r\\n\\t\\tflex-direction: column;\\r\\n\\t\\theight: 20em;\\r\\n\\t\\tbackground-color: red;\\r\\n\\t}\\r\\n\\tul {\\r\\n\\t\\tdisplay: flex;\\r\\n\\t}\\r\\n\\th2 {\\r\\n\\t\\tfont-size: 1rem;\\r\\n\\t}\\r\\n\\ta {\\r\\n\\t\\ttext-decoration: none;\\r\\n\\t\\tcolor: black;\\r\\n\\t}\\r\\n</style>\\r\\n<div>\\r\\n<h1>Architectuur van Indonesië</h1>\\r\\n<ul>\\r\\n\\t{#each data as source}\\r\\n\\t<li><a href=\\\"details/{source.cho.value.slice(-6)}\\\">\\r\\n\\t\\t<h2>{source.modelNaam.value}</h2>\\r\\n\\t\\t<img src={source.imageModel.value} alt={source.modelNaam.value}>\\r\\n\\t</a></li>\\r\\n\\t{/each}\\r\\n</ul>\\r\\n</div>\"],\"names\":[],\"mappings\":\"AAMC,GAAG,eAAC,CAAC,AACJ,KAAK,CAAE,IAAI,AACZ,CAAC,AACD,GAAG,eAAC,CAAC,AACJ,UAAU,CAAE,IAAI,uBAAuB,CAAC,CAAC,SAAS,CAClD,eAAe,CAAE,IAAI,CACrB,MAAM,CAAE,IAAI,AACb,CAAC,AACD,EAAE,eAAC,CAAC,AACH,KAAK,CAAE,GAAG,CACV,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,MAAM,CAAE,IAAI,CACZ,gBAAgB,CAAE,GAAG,AACtB,CAAC,AACD,EAAE,eAAC,CAAC,AACH,OAAO,CAAE,IAAI,AACd,CAAC,AACD,EAAE,eAAC,CAAC,AACH,SAAS,CAAE,IAAI,AAChB,CAAC,AACD,CAAC,eAAC,CAAC,AACF,eAAe,CAAE,IAAI,CACrB,KAAK,CAAE,KAAK,AACb,CAAC\"}"
};
...
const Home = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="svelte-1an2mgi">
	<h1>Architectuur van Indonesië</h1>
	<ul class="svelte-1an2mgi">
		${each(data, (source) => `<li class="svelte-1an2mgi"><a href="details/${escape(source.cho.value.slice(-6))}" class="svelte-1an2mgi">
			<h2 class="svelte-1an2mgi">${escape(source.modelNaam.value)}</h2>
			<img${add_attribute("src", source.imageModel.value, 0)}${add_attribute("alt", source.modelNaam.value, 0)} class="svelte-1an2mgi">
		</a></li>`)}
	</ul>
	</div>`;
});
...
const Detail = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${ dataModel.length == 1 ? `<h1>${escape(dataModel[0].modelNaam.value)}</h1>
		<img${add_attribute("src", dataModel[0].imageModel.value, 0)} alt="">` : `` }`;
});
