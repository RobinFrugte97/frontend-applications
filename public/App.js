...
const Home = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<h1>Architectuur van Indonesië</h1>
	<ul>
		${each(data, (source) => `<a href="details/${escape(source.cho.value.slice(-6))}"><li>
...
const Detail = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<h1>${escape(dataModel[0].modelNaam.value)}</h1>
