...
const Home = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="svelte-1e4hgwd">
	<h1>Architectuur van Indonesië</h1>
	<ul class="svelte-1e4hgwd">
		${each(data, (source) => `<li class="svelte-1e4hgwd"><a href="details/${escape(source.cho.value.slice(-6))}" class="svelte-1e4hgwd">
			<img${add_attribute("src", source.imageModel.value, 0)}${add_attribute("alt", source.modelName.value, 0)} class="svelte-1e4hgwd">
			<h2 class="svelte-1e4hgwd">${escape(source.modelName.value)}</h2>
		</a></li>`)}
	</ul>
	</div>`;
});
